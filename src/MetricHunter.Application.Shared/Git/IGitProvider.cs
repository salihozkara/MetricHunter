...
{
    Task<bool> CloneRepository(Repository repository, string cloneBaseDirectoryPath = "", CancellationToken token = default);
    ...
    Task<bool> DeleteLocalRepository(Repository repository, string cloneBaseDirectoryPath = "", CancellationToken token = default);
