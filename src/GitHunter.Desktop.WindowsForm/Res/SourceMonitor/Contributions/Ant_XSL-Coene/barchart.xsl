...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/">
        ...
        <svg width="436pt" height="327pt" viewBox="0 0 4360 3270">
            ...
            <g transform="translate(190 640) rotate(-90)"
               style="fill:#008080; font-family:Times New Roman;font-size:100; text-anchor:end; ">
                <text>
                    <xsl:value-of select="$labely"/>
                </text>
            </g>
            ...
            <text x="4100" y="3110" style="fill:#008080; font-family:Times New Roman;font-size:100; text-anchor:end;">
                <xsl:value-of select="$labelx"/>
            </text>
            ...
            <!-- x-axis with ticks -->
            <path style="stroke:#000000; stroke-width:6"
